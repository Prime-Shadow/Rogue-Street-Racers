...
public class WaypointEditor : MonoBehaviour
{
    ...
    public static void OnDrawSceneGizmo(Waypoint waypoint, GizmoType gizmoType)
    {
        ...
        // now draw a line to next waypoint
        ...
        if (waypoint.nextWaypoint != null)
        {
            ...
            Vector3 offset = waypoint.transform.right * -waypoint.waypointWidth / 2f;           // use -waypoint.waypointWidth because waypoint.transform.left does not exist
            Vector3 offsetTo = waypoint.previousWaypoint.transform.right * -waypoint.previousWaypoint.waypointWidth / 2f; // use -waypoint.waypointWidth because waypoint.transform.left does not exist
